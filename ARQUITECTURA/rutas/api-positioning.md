...
Handler `positioning` · `app/api.py:1338` (cuerpo hasta la 1342) · decorador en la linea 1337.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:148`, `harness/checks/K43-foto-unica.sh:208` | — |
| **panel-sobre** | `static/app.js:1802` | — |
