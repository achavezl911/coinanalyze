...
Handler `liquidation_series` · `app/api.py:987` (cuerpo hasta la 1033) · decorador en la linea 986.
...
|---|---|---|
| **checks** | `harness/checks/K02-cobertura-hueco.sh:66`, `harness/checks/K03-hueco-declarado.sh:46` | `harness/checks/K31-cubos.py:41` |
