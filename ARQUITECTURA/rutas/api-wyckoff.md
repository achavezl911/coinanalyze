...
|---|---|---|
| **checks** | `harness/checks/K43-control.bash:187`, `harness/checks/K43-foto-unica.sh:159`, `harness/checks/K43-foto-unica.sh:218`, `harness/checks/K44-control.bash:155` _(+4)_ | `harness/checks/K43-control.bash:229`, `harness/checks/K44-control.bash:152` |
