...
Handler `flow_spot_vs_perp` · `app/api.py:1724` (cuerpo hasta la 1746) · decorador en la linea 1723.
...
| 422 | interval debe ser 4hour o daily: son los que Coinalyze sirve con historia | `app/api.py:1738` | el propio handler |
