...
Handler `flow_spot_vs_perp` · `app/api.py:1679` (cuerpo hasta la 1701) · decorador en la linea 1678.
...
| 422 | interval debe ser 4hour o daily: son los que Coinalyze sirve con historia | `app/api.py:1693` | el propio handler |
