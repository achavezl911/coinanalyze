...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:117`, `harness/checks/K43-foto-unica.sh:177`, `harness/checks/K80-la-matriz-cambia-de-universo.sh:169`, `harness/checks/K80-la-matriz-cambia-de-universo.sh:170` _(+1)_ | — |
