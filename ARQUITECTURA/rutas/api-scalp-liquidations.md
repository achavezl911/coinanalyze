...
Handler `scalp_liquidations` · `app/api.py:1521` (cuerpo hasta la 1524) · decorador en la linea 1520.
...
| campo | de donde sale |
|---|---|
| `matrix` | literal en app/scalp_logic.py:5498 |
| `recent` | literal en app/scalp_logic.py:5498 |
| `symbol` | literal en app/scalp_logic.py:5498 |
