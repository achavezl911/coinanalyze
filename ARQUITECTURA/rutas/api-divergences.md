...
Handler `divergences_endpoint` · `app/api.py:2097` (cuerpo hasta la 2100) · decorador en la linea 2096.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:110`, `harness/checks/K43-foto-unica.sh:159` | — |
| **panel** | `static/app.js:1774` | — |
