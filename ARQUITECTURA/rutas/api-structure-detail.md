...
Handler `structure_detail_endpoint` · `app/api.py:1811` (cuerpo hasta la 1814) · decorador en la linea 1810.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:97`, `harness/checks/K43-foto-unica.sh:150` | `harness/checks/K31-eslabon5.sh:29` |
| **panel** | `static/app.js:1529`, `static/app.js:1631` | — |
