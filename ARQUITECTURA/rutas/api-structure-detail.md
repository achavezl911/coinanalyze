...
Handler `structure_detail_endpoint` · `app/api.py:2136` (cuerpo hasta la 2139) · decorador en la linea 2135.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:146`, `harness/checks/K43-foto-unica.sh:204` | `harness/checks/K31-eslabon5.sh:29` |
| **panel-sobre** | `static/app.js:1634`, `static/app.js:1773` | — |
