...
Handler `ai_context` · `app/api.py:3511` (cuerpo hasta la 3524) · decorador en la linea 3510.
...
| 422 | — | `app/api.py:3520` | el propio handler |
...
|---|---|---|
| **checks** | `harness/checks/K31-eslabon5.sh:65`, `harness/checks/K43-foto-unica.sh:336`, `harness/checks/K43-foto-unica.sh:337`, `harness/checks/K43-foto-unica.sh:413` _(+10)_ | `harness/checks/K31-eslabon5.sh:60`, `harness/checks/K31-eslabon5.sh:172`, `harness/checks/K43-foto-unica.sh:7`, `harness/checks/K43-foto-unica.sh:17` _(+7)_ |
| **panel** | `static/js/02-canal.js:35`, `static/js/02-canal.js:49`, `static/js/02-canal.js:53`, `static/js/10-contexto-y-estructura.js:912` _(+4)_ | — |
