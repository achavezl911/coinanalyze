...
Handler `ai_context` · `app/api.py:2590` (cuerpo hasta la 2603) · decorador en la linea 2589.
...
| 422 | — | `app/api.py:2599` | el propio handler |
