...
| `app.scalp_logic.cross_asset` | 5 | 3 | **6** | [impacto](../impacto/app-scalp_logic.md) |
| `app.scalp_logic._beta` | 5 | 0 | **5** | [impacto](../impacto/app-scalp_logic.md) |
| `app.scalp_logic._binned` | 5 | 0 | **5** | [impacto](../impacto/app-scalp_logic.md) |
| `app.scalp_logic._pearson` | 5 | 0 | **5** | [impacto](../impacto/app-scalp_logic.md) |
| `app.scalp_logic._returns` | 5 | 0 | **5** | [impacto](../impacto/app-scalp_logic.md) |
| `app.api.cross_asset_endpoint` | 1 | 0 | **1** | [impacto](../impacto/app-api.md) |
