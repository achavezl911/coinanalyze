...
Handler `scalp_absorption` · `app/api.py:1766` (cuerpo hasta la 1771) · decorador en la linea 1765.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:149`, `harness/checks/K43-foto-unica.sh:211` | — |
| **panel-sobre** | `static/app.js:1743` | — |
