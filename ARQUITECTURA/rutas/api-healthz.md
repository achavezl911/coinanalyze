...
Handler `health` · `app/api.py:3629` (cuerpo hasta la 3683) · decorador en la linea 3628.
...
| campo | de donde sale |
|---|---|
| `database` | literal en app/api.py:3677 |
| `governed_services` | literal en app/api.py:3680 |
| `missing_services` | literal en app/api.py:3678 |
| `missing_symbols` | literal en app/api.py:3679 |
| `services` | literal en app/api.py:3681 |
| `status` | literal en app/api.py:3672 |
| `symbols` | literal en app/api.py:3682 |
