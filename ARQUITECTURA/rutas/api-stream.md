...
|---|---|---|
| **checks** | `harness/checks/K20-cincoxx.sh:126`, `harness/checks/K31-eslabon5.sh:65`, `harness/checks/K43-foto-unica.sh:160` | `harness/checks/K20-cincoxx.sh:124`, `harness/checks/K31-eslabon5.sh:57` |
| **panel** | `static/app.js:1860` | — |
