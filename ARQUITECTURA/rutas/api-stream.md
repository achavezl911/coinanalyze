...
Handler `stream` · `app/api.py:3587` (cuerpo hasta la 3592) · decorador en la linea 3586.
...
- `app.api.stream_generator` — `app/api.py:3539`
...
|---|---|---|
| **checks** | `harness/checks/K20-cincoxx.sh:126`, `harness/checks/K31-eslabon5.sh:60`, `harness/checks/K43-foto-unica.sh:160` | `harness/checks/K20-cincoxx.sh:124`, `harness/checks/K31-eslabon5.sh:57` |
| **panel** | `static/app.js:1790` | — |
