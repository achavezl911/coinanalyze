...
Handler `setup` · `app/api.py:2040` (cuerpo hasta la 2051) · decorador en la linea 2039.
...
| `snapshot_ts` | literal en app/api.py:2049 |
| `symbol` | literal en app/api.py:2048 |
...
|---|---|---|---|
| 404 | No data | `app/api.py:2045` | el propio handler |
...
|---|---|---|
| **checks** | — | `harness/checks/K88-control.bash:158`, `harness/checks/K88-control.bash:159`, `harness/checks/K88-control.bash:476` |
