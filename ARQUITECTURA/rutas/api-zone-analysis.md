...
| `app.api.zone_analysis_endpoint` | 1 | 0 | **1** | [impacto](../impacto/app-api.md) |
| `app.scalp_logic.zone_analysis` | 1 | 0 | **1** | [impacto](../impacto/app-scalp_logic.md) |
| `app.zones._atr_pct` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
| `app.zones._clamp` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
| `app.zones._effort_result` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
| `app.zones._narrative` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
| `app.zones._oi_behaviour` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
| `app.zones._percentile` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
| `app.zones._rejection` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
| `app.zones.zone_character_read` | 1 | 0 | **1** | [impacto](../impacto/app-zones.md) |
