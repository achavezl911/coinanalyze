...
|---|---|---|
| **checks** | `harness/checks/K31-eslabon5.sh:66`, `harness/checks/K43-control.bash:135`, `harness/checks/K43-foto-unica.sh:161`, `harness/checks/K43-foto-unica.sh:452` | `harness/checks/K43-foto-unica.sh:105` |
