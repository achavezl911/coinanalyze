...
Handler `signals_visibility` · `app/api.py:2937` (cuerpo hasta la 3016) · decorador en la linea 2936.
...
| campo | de donde sale |
|---|---|
| `as_of` | literal en app/api.py:3010 |
| `certificates` | literal en app/api.py:3015 |
| `count` | literal en app/api.py:3013 |
| `limit` | literal en app/api.py:3012 |
| `since` | literal en app/api.py:3007 |
| `status` | literal en app/api.py:3011 |
| `symbol` | literal en app/api.py:3006 |
| `truncated` | literal en app/api.py:3014 |
| `until` | literal en app/api.py:3008 |
| `ventana_maxima_h` | literal en app/api.py:3009 |
...
| 422 | status tiene que ser evaluated o not_evaluable | `app/api.py:2962` | el propio handler |
| 422 | — | `app/api.py:2970` | el propio handler |
| 422 | since/until necesitan zona horaria explicita | `app/api.py:2972` | el propio handler |
| 422 | until tiene que ser posterior a since | `app/api.py:2974` | el propio handler |
| 422 | — | `app/api.py:2976` | el propio handler |
...
|---|---|---|
| **checks** | `harness/checks/K25-visibilidad-de-lo-final.sh:110`, `harness/checks/K43-control.bash:90`, `harness/checks/K43-foto-unica.sh:163` | — |
| **panel** | `static/js/07-decision-y-ciclos.js:407` | — |
