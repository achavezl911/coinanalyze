...
|---|---|---|
| **checks** | `harness/checks/K25-visibilidad-de-lo-final.sh:110`, `harness/checks/K43-control.bash:90`, `harness/checks/K43-foto-unica.sh:155` | — |
| **panel** | `static/app.js:1832` | — |
