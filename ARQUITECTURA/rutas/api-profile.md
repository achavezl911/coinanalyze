...
Handler `trading_profile` · `app/api.py:1527` (cuerpo hasta la 1543) · decorador en la linea 1526.
...
| 422 | — | `app/api.py:1531` | el propio handler |
...
|---|---|---|
| **checks** | — | `harness/checks/K31-cubos.py:62`, `harness/checks/K43-foto-unica.sh:43`, `harness/checks/K43-foto-unica.sh:77`, `harness/checks/K43-foto-unica.sh:201` _(+2)_ |
