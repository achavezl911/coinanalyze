...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:151`, `harness/checks/K43-foto-unica.sh:205` | — |
| **panel-sobre** | `static/js/07-decision-y-ciclos.js:344`, `static/js/07-decision-y-ciclos.js:417` | — |
