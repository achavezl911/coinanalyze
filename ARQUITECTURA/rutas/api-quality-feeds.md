...
Handler `quality_feeds` · `app/api.py:1538` (cuerpo hasta la 1550) · decorador en la linea 1537.
...
| campo | de donde sale |
|---|---|
| `collectors` | literal en app/scalp_logic.py:5341 |
| `contexts` | literal en app/scalp_logic.py:5342 |
| `contexts.intraday` | literal en app/scalp_logic.py:5344 |
| `contexts.macro` | literal en app/scalp_logic.py:5345 |
| `contexts.scalp` | literal en app/scalp_logic.py:5343 |
| `metrics` | literal en app/scalp_logic.py:4006 |
| `note` | literal en app/scalp_logic.py:4007 |
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:144`, `harness/checks/K43-foto-unica.sh:199` | `harness/checks/K43-foto-unica.sh:43` |
| **panel** | — | `static/app.js:1813` |
| **panel-sobre** | `static/app.js:1817` | — |
| **readme** | — | `README.md:32` |
...
**Declarada** en [`declarada/api-quality-feeds.md`](../declarada/api-quality-feeds.md) — pregunta del trader,
