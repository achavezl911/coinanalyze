...
|---|---|---|
| **checks** | `harness/checks/K31-eslabon5.sh:66`, `harness/checks/K43-foto-unica.sh:153`, `harness/checks/K43-foto-unica.sh:425` | `harness/checks/K43-foto-unica.sh:97` |
