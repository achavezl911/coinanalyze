...
|---|---|---|
| **checks** | `harness/checks/K31-eslabon5.sh:66`, `harness/checks/K43-foto-unica.sh:161`, `harness/checks/K43-foto-unica.sh:450` | `harness/checks/K43-foto-unica.sh:105` |
| **panel** | `static/app.js:3616` | — |
