...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:155`, `harness/checks/K43-foto-unica.sh:213` | — |
| **panel-sobre** | `static/js/07-decision-y-ciclos.js:208`, `static/js/07-decision-y-ciclos.js:347` | — |
