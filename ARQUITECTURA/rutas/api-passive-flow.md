...
Handler `passive_flow_endpoint` · `app/api.py:2121` (cuerpo hasta la 2124) · decorador en la linea 2120.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:144`, `harness/checks/K43-foto-unica.sh:198` | — |
| **panel-sobre** | `static/app.js:1770` | — |
...
**Declarada** en [`declarada/api-passive-flow.md`](../declarada/api-passive-flow.md) — pregunta del trader,
...
| `app.scalp_logic.passive_flow` | 5 | **0** | 3 ↑ | **5** | [impacto](../impacto/app-scalp_logic.md) |
| `app.scalp_logic.volume_profile` | 6 | **0** | 0 | **6** | [impacto](../impacto/app-scalp_logic.md) |
| `app.scalp_logic._classify_passive` | 5 | **0** | 0 | **5** | [impacto](../impacto/app-scalp_logic.md) |
| `app.api.passive_flow_endpoint` | 1 | **0** | 0 | **1** | [impacto](../impacto/app-api.md) |
