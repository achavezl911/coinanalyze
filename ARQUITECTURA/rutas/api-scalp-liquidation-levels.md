...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:153`, `harness/checks/K43-foto-unica.sh:209`, `harness/checks/K44-control.bash:282`, `harness/checks/K44-control.bash:283` _(+3)_ | `harness/checks/K44-control.bash:251` |
