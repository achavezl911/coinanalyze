...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:154`, `harness/checks/K43-foto-unica.sh:210`, `harness/checks/K44-control.bash:289`, `harness/checks/K44-control.bash:290` _(+3)_ | `harness/checks/K44-control.bash:258` |
