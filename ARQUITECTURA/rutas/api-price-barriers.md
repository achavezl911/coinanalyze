...
Handler `price_barriers_endpoint` · `app/api.py:1676` (cuerpo hasta la 1679) · decorador en la linea 1675.
...
**Declarada** en [`declarada/api-price-barriers.md`](../declarada/api-price-barriers.md) — pregunta del trader,
