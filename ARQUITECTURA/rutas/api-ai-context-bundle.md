...
| campo | de donde sale |
|---|---|
| `build_finished_at` | asignado en app/ai_context.py:1034 |
| `build_started_at` | asignado en app/ai_context.py:1033 |
| `generated_at` | literal en app/ai_context.py:1028 |
| `interpretation_prompt` | literal en app/ai_context.py:1026 |
| `local_alerts` | literal en app/ai_context.py:1030 |
| `profile` | literal en app/ai_context.py:1029 |
| `rough_token_estimate` | asignado en app/ai_context.py:1035 |
| `schema_version` | literal en app/ai_context.py:1025 |
| `symbols` | literal en app/ai_context.py:1031 |
...
168 funciones del arbol son alcanzables desde este handler. **Tocar cualquiera
de ellas puede cambiar esta ruta**; es la mitad de abajo del radio de impacto.

Llamadas directas del handler:

- `app.ai_context.build_ai_context` — `app/ai_context.py:990`
- `app.ai_context.normalize_profile` — `app/ai_context.py:211`
- `app.api.validate_symbol` — `app/api.py:229`

<details><summary>Alcanzables de forma indirecta (165)</summary>
...
| _… y 144 mas_ | | | | | [IMPACTO.md](../IMPACTO.md) |
