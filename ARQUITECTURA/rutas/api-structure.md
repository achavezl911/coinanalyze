...
Handler `structure` · `app/api.py:2201` (cuerpo hasta la 2204) · decorador en la linea 2200.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:146`, `harness/checks/K43-foto-unica.sh:203` | — |
