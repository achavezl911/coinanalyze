...
Handler `structure` · `app/api.py:1917` (cuerpo hasta la 1920) · decorador en la linea 1916.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:97`, `harness/checks/K43-foto-unica.sh:131` | — |
