...
|---|---|---|
| **checks** | `harness/checks/K31-eslabon5.sh:61`, `harness/checks/K43-foto-unica.sh:121`, `harness/checks/K43-foto-unica.sh:342`, `harness/checks/K76-la-ventana-que-pides.sh:97` | — |
| **panel** | `static/app.js:3646` | — |
