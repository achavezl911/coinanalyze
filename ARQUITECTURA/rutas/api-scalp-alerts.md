...
Handler `scalp_alerts` · `app/api.py:1737` (cuerpo hasta la 1798) · decorador en la linea 1736.
...
| campo | de donde sale |
|---|---|
| `alerts` | literal en app/api.py:1798 |
| `symbol` | literal en app/api.py:1798 |
...
- `app.api.statistical_alerts` — `app/api.py:1801`
