...
|---|---|---|
| **checks** | `harness/checks/K02-cobertura-hueco.sh:46`, `harness/checks/K03-hueco-declarado.sh:46` | `harness/checks/K02-cobertura-hueco.sh:5`, `harness/checks/K31-cubos.py:40`, `harness/checks/K88-control.bash:324`, `harness/checks/K88-control.bash:416` _(+1)_ |
