...
Handler `prometheus_metrics` · `app/api.py:3314` (cuerpo hasta la 3388) · decorador en la linea 3313.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3296`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3316` | el propio handler |
