...
Handler `prometheus_metrics` · `app/api.py:3151` (cuerpo hasta la 3225) · decorador en la linea 3150.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3133`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3153` | el propio handler |
