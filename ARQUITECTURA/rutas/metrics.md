...
Handler `prometheus_metrics` · `app/api.py:3467` (cuerpo hasta la 3541) · decorador en la linea 3466.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3449`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3469` | el propio handler |
