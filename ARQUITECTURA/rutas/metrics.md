...
Handler `prometheus_metrics` · `app/api.py:3020` (cuerpo hasta la 3094) · decorador en la linea 3019.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3002`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3022` | el propio handler |
