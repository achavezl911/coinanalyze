...
Handler `prometheus_metrics` · `app/api.py:3590` (cuerpo hasta la 3664) · decorador en la linea 3589.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3572`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3592` | el propio handler |
