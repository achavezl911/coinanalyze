...
Handler `prometheus_metrics` · `app/api.py:3551` (cuerpo hasta la 3625) · decorador en la linea 3550.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3533`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3553` | el propio handler |
