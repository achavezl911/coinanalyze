...
Handler `prometheus_metrics` · `app/api.py:3142` (cuerpo hasta la 3216) · decorador en la linea 3141.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3124`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3144` | el propio handler |
