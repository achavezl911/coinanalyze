...
Handler `prometheus_metrics` · `app/api.py:3404` (cuerpo hasta la 3478) · decorador en la linea 3403.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:3386`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:3406` | el propio handler |
