...
Handler `prometheus_metrics` · `app/api.py:2781` (cuerpo hasta la 2855) · decorador en la linea 2780.
...
- `app.api._parse_heartbeat_detail` — `app/api.py:2763`
...
|---|---|---|---|
| 404 | Metrics disabled | `app/api.py:2783` | el propio handler |
