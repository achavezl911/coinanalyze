...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:154`, `harness/checks/K43-foto-unica.sh:209`, `harness/checks/K44-control.bash:175`, `harness/checks/K44-control.bash:188` _(+8)_ | `harness/checks/K83-la-ventana-pide-la-fuente-que-no-tiene-el-dato.sh:79` |
