...
Handler `data_confidence` · `app/api.py:2964` (cuerpo hasta la 2968) · decorador en la linea 2963.
...
| campo | de donde sale |
|---|---|
| `rows` | literal en app/api.py:2968 |
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:142`, `harness/checks/K43-foto-unica.sh:193` | — |
