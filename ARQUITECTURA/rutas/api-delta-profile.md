...
Handler `delta_profile_endpoint` · `app/api.py:1801` (cuerpo hasta la 1826) · decorador en la linea 1800.
...
| 422 | — | `app/api.py:1818` | el propio handler |
