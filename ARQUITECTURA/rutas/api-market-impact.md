...
Handler `market_impact_endpoint` · `app/api.py:1120` (cuerpo hasta la 1124) · decorador en la linea 1119.
...
|---|---|---|
| **checks** | `harness/checks/K43-foto-unica.sh:99`, `harness/checks/K43-foto-unica.sh:135` | — |
