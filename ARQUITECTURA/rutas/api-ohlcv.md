...
Handler `ohlcv` · `app/api.py:635` (cuerpo hasta la 695) · decorador en la linea 634.
...
|---|---|---|
| **checks** | `harness/checks/K02-cobertura-hueco.sh:66`, `harness/checks/K03-hueco-declarado.sh:46`, `harness/checks/K20-cincoxx.sh:68`, `harness/checks/K20-cincoxx.sh:83` _(+2)_ | `harness/checks/K02-cobertura-hueco.sh:63`, `harness/checks/K03-hueco-declarado.sh:7`, `harness/checks/K43-foto-unica.sh:336` |
| **panel** | `static/app.js:1504` | — |
