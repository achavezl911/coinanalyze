...
| `/api/ai/profiles` | GET | 2 | 0 | 0 | [ficha](rutas/api-ai-profiles.md) |
...
| `/api/cvd` | GET | 5 | 2 | 11 | [ficha](rutas/api-cvd.md) |
| `/api/cvd-matrix` | GET | 4 | 1 | 16 | [ficha](rutas/api-cvd-matrix.md) |
...
| `/api/ohlcv` | GET | 5 | 2 | 11 | [ficha](rutas/api-ohlcv.md) |
| `/api/oi` | GET | 5 | 2 | 11 | [ficha](rutas/api-oi.md) |
| `/api/oi-context` | GET | 11 | 4 | 12 | [ficha](rutas/api-oi-context.md) |
| `/api/passive-flow` | GET | 9 | 3 | 20 | [ficha](rutas/api-passive-flow.md) |
...
| `/api/quality/feeds` | GET | 4 | 10 | 43 | [ficha](rutas/api-quality-feeds.md) |
| `/api/range/validate` | GET | 5 | 1 | 8 | [ficha](rutas/api-range-validate.md) |
| `/api/reference-levels` | GET | 6 | 1 | 3 | [ficha](rutas/api-reference-levels.md) |
