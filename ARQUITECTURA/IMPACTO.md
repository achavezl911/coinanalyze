...
| [`app.api.rechaza_parametros_desconocidos`](impacto/app-api.md) | `app/api.py:2493` | 7 | **0** | 0 | **7** |
...
| [`app.api.health`](impacto/app-api.md) | `app/api.py:3629` | 1 | **0** | 7 ↑ | **1** |
...
| [`app.api._parse_heartbeat_detail`](impacto/app-api.md) | `app/api.py:3533` | 1 | **0** | 0 | **1** |
| [`app.api._slippage_para`](impacto/app-api.md) | `app/api.py:1648` | 1 | **0** | 0 | **1** |
| [`app.api.ai_context`](impacto/app-api.md) | `app/api.py:3472` | 1 | **0** | 0 | **1** |
| [`app.api.ai_context_bundle`](impacto/app-api.md) | `app/api.py:3489` | 1 | **0** | 0 | **1** |
| [`app.api.ai_profiles`](impacto/app-api.md) | `app/api.py:3510` | 1 | **0** | 0 | **1** |
...
| [`app.api.dashboard_state`](impacto/app-api.md) | `app/api.py:3441` | 1 | **0** | 0 | **1** |
| [`app.api.data_confidence`](impacto/app-api.md) | `app/api.py:3048` | 1 | **0** | 0 | **1** |
...
| [`app.api.index`](impacto/app-api.md) | `app/api.py:3743` | 1 | **0** | 0 | **1** |
| [`app.api.level_breakout_endpoint`](impacto/app-api.md) | `app/api.py:2021` | 1 | **0** | 0 | **1** |
| [`app.api.liquidation_levels`](impacto/app-api.md) | `app/api.py:2988` | 1 | **0** | 0 | **1** |
...
| [`app.api.prometheus_metrics`](impacto/app-api.md) | `app/api.py:3551` | 1 | **0** | 0 | **1** |
...
| [`app.api.scalp_basis`](impacto/app-api.md) | `app/api.py:2981` | 1 | **0** | 0 | **1** |
...
| [`app.api.scalp_persistence`](impacto/app-api.md) | `app/api.py:3101` | 1 | **0** | 0 | **1** |
...
| [`app.api.signal_base_rate`](impacto/app-api.md) | `app/api.py:3316` | 1 | **0** | 0 | **1** |
| [`app.api.signals_execution`](impacto/app-api.md) | `app/api.py:2726` | 1 | **0** | 0 | **1** |
| [`app.api.signals_ledger`](impacto/app-api.md) | `app/api.py:2509` | 1 | **0** | 0 | **1** |
| [`app.api.signals_outcomes`](impacto/app-api.md) | `app/api.py:2640` | 1 | **0** | 0 | **1** |
| [`app.api.signals_replay`](impacto/app-api.md) | `app/api.py:2814` | 1 | **0** | 0 | **1** |
| [`app.api.signals_visibility`](impacto/app-api.md) | `app/api.py:2898` | 1 | **0** | 0 | **1** |
...
| [`app.api.stream`](impacto/app-api.md) | `app/api.py:3734` | 1 | **0** | 0 | **1** |
| [`app.api.stream_generator`](impacto/app-api.md) | `app/api.py:3686` | 1 | **0** | 0 | **1** |
