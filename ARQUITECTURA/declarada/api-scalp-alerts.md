...
**El recuento vive en la ficha derivada**, que se regenera: [`rutas/api-scalp-alerts.md`](../rutas/api-scalp-alerts.md), seccion *Superficie*. Aqui NO se copia el numero.
