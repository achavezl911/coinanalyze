...
|---|---|---|---|---|---|
| [`_pct`](#-pct) | 41 | 1 | **0** | 0 | **1** |
| [`coste_de_carry`](#coste-de-carry) | 45 | 1 | **0** | 0 | **1** |
| [`matriz_de_carry`](#matriz-de-carry) | 73 | 1 | **0** | 0 | **1** |
| [`quien_paga`](#quien-paga) | 62 | 1 | **0** | 0 | **1** |

## _pct

`app/carry.py:41` · clave completa `app.carry._pct`
...
`app/carry.py:45` · clave completa `app.carry.coste_de_carry`
...
`app/carry.py:73` · clave completa `app.carry.matriz_de_carry`
...
`app/carry.py:62` · clave completa `app.carry.quien_paga`
