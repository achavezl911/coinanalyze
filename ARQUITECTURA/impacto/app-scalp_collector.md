...
|---|---|---|---|---|
| [`owns_global_cleanup`](#owns-global-cleanup) | 1524 | 0 | 25 | **25** |
| [`persist_scalp_signals`](#persist-scalp-signals) | 1347 | 0 | 24 | **24** |
| [`_write_combined_minute`](#-write-combined-minute) | 795 | 0 | 21 | **21** |
| [`_write_combined_realtime`](#-write-combined-realtime) | 766 | 0 | 21 | **21** |
| [`_write_trade_rows`](#-write-trade-rows) | 710 | 0 | 21 | **21** |
| [`flush_trades`](#flush-trades) | 637 | 0 | 21 | **21** |
| [`all_expected_fresh`](#all-expected-fresh) | 629 | 0 | 20 | **20** |
| [`monitor`](#monitor) | 1452 | 0 | 20 | **20** |
| [`persist_liquidation_health_snapshot`](#persist-liquidation-health-snapshot) | 525 | 0 | 20 | **20** |
| [`_write_combined_books`](#-write-combined-books) | 896 | 0 | 19 | **19** |
| [`_write_ladders`](#-write-ladders) | 864 | 0 | 19 | **19** |
| [`binance_loop`](#binance-loop) | 988 | 0 | 19 | **19** |
| [`binance_market_loop`](#binance-market-loop) | 1098 | 0 | 19 | **19** |
| [`bybit_loop`](#bybit-loop) | 1150 | 0 | 19 | **19** |
| [`cleanup`](#cleanup) | 1559 | 0 | 19 | **19** |
| [`cleanup_expired_rows`](#cleanup-expired-rows) | 1528 | 0 | 19 | **19** |
| [`drenar_minutos`](#drenar-minutos) | 682 | 0 | 19 | **19** |
| [`flush_books`](#flush-books) | 821 | 0 | 19 | **19** |
| [`flush_liquidations`](#flush-liquidations) | 954 | 0 | 19 | **19** |
| [`handle_binance`](#handle-binance) | 1044 | 0 | 19 | **19** |
| [`handle_bybit`](#handle-bybit) | 1236 | 0 | 19 | **19** |
| [`main`](#main) | 1575 | 0 | 19 | **19** |
| [`mark_exchange_disconnected`](#mark-exchange-disconnected) | 624 | 0 | 19 | **19** |
| [`persist_liquidation_feed_state`](#persist-liquidation-feed-state) | 463 | 0 | 19 | **19** |
| [`reset_liquidation_feed_health`](#reset-liquidation-feed-health) | 604 | 0 | 19 | **19** |
| [`segundos_cubiertos`](#segundos-cubiertos) | 673 | 0 | 17 | **17** |
| [`persist_liquidation_event_loss`](#persist-liquidation-event-loss) | 580 | 0 | 7 | **7** |
