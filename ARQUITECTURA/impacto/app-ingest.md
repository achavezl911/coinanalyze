...
|---|---|---|---|---|
| [`_reconcile_persisted_cadence`](#-reconcile-persisted-cadence) | 453 | 0 | 52 | **52** |
| [`barrido_cadencia_persistido`](#barrido-cadencia-persistido) | 568 | 0 | 51 | **51** |
| [`finite`](#finite) | 46 | 0 | 51 | **51** |
| [`rollup_ohlcv_5m`](#rollup-ohlcv-5m) | 184 | 0 | 51 | **51** |
| [`rows_for`](#rows-for) | 89 | 0 | 51 | **51** |
| [`upsert_ohlcv`](#upsert-ohlcv) | 101 | 0 | 51 | **51** |
| [`valid_ts`](#valid-ts) | 59 | 0 | 51 | **51** |
| [`ventana_barrido_cadencia`](#ventana-barrido-cadencia) | 538 | 0 | 51 | **51** |
| [`_reconcile_response_cadence`](#-reconcile-response-cadence) | 619 | 0 | 47 | **47** |
| [`_coverage_heartbeat_detail`](#-coverage-heartbeat-detail) | 687 | 0 | 41 | **41** |
| [`publish_snapshot`](#publish-snapshot) | 367 | 0 | 41 | **41** |
| [`ingest_ohlcv_cycle`](#ingest-ohlcv-cycle) | 746 | 0 | 39 | **39** |
| [`_liquidation_history_observation`](#-liquidation-history-observation) | 649 | 0 | 11 | **11** |
| [`ingest_metrics_cycle`](#ingest-metrics-cycle) | 814 | 0 | 11 | **11** |
| [`source_response_buckets`](#source-response-buckets) | 66 | 0 | 11 | **11** |
| [`upsert_liquidations`](#upsert-liquidations) | 293 | 0 | 11 | **11** |
| [`upsert_long_short`](#upsert-long-short) | 326 | 0 | 11 | **11** |
| [`upsert_ohlc_metric`](#upsert-ohlc-metric) | 240 | 0 | 11 | **11** |
| [`run`](#run) | 1032 | 0 | 7 | **7** |
| [`run_aligned_feed`](#run-aligned-feed) | 1006 | 0 | 7 | **7** |
| [`seconds_until_aligned_run`](#seconds-until-aligned-run) | 997 | 0 | 7 | **7** |

## _reconcile_persisted_cadence

`app/ingest.py:453` · clave completa `app.ingest._reconcile_persisted_cadence`

**Radio total: 52 rutas** de 68.
