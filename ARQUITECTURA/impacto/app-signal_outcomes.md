...
|---|---|---|---|---|
| [`materialize_due_signal_outcomes`](#materialize-due-signal-outcomes) | 289 | 0 | 24 | **24** |
| [`_aware_utc`](#-aware-utc) | 57 | 0 | 9 | **9** |
| [`_defer_missing_path`](#-defer-missing-path) | 217 | 0 | 9 | **9** |
| [`_finalize_evaluated`](#-finalize-evaluated) | 241 | 0 | 9 | **9** |
| [`_finalize_not_evaluable`](#-finalize-not-evaluable) | 189 | 0 | 9 | **9** |
| [`_finite_positive`](#-finite-positive) | 63 | 0 | 9 | **9** |
| [`compute_path_metrics`](#compute-path-metrics) | 96 | 0 | 9 | **9** |
| [`expected_bar_timestamps`](#expected-bar-timestamps) | 89 | 0 | 9 | **9** |
| [`schedule_signal_outcomes`](#schedule-signal-outcomes) | 155 | 0 | 9 | **9** |
| [`outcome_window`](#outcome-window) | 73 | 0 | 5 | **5** |
