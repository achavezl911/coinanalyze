...
-- Compatibility bridge for the future daily-partitioned table. Keep the legacy
-- two-column primary key until partition conversion, while making the future
-- three-column conflict target usable by this release on either schema.
DO $$
DECLARE
