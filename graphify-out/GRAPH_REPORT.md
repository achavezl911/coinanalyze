# Graph Report - pr24-daily-historical-integrity  (2026-08-11)

## Corpus Check
- 222 files · ~266,751 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3651 nodes · 9074 edges · 231 communities (206 shown, 25 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 252 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c313f993`
...
8. `build_ai_symbol_context()` - 50 edges
9. `asNumber()` - 47 edges
10. `number()` - 45 edges
...
Cohesion: 0.15
Nodes (25): binance_loop(), binance_market_loop(), bybit_loop(), cleanup(), cleanup_expired_rows(), flush_books(), flush_liquidations(), main() (+17 more)
...
Cohesion: 0.09
Nodes (30): _classify_passive(), Detecta absorcion por limites pasivos y la mapea a…, _bars(), _blocks(), Regresiones de la auditoria v1.3.8. Cada test fija una conclusion que se…, Medido en vivo (BTC): score 45 con 4 de 7 componentes mudos se publicaba como…, HH_HL en 1d y LH_LL en 3d se promediaban a 0 y quedaban indistinguibles de 'sin…, Para BTC, cross_asset.relative_strength_vs_base_pct es null en todas las… (+22 more)
...
Cohesion: 0.15
Nodes (48): mark_feed_degraded(), mark_feed_error(), _mark_feed_unhealthy(), evaluate_walk_forward(), Stage B: hash/schedule-verified read-only walk-forward evaluation., _Connection, _canonical_json(), _insert_backdated_manifest() (+40 more)

### Community 18 - "data_gaps.py"
Cohesion: 0.09
Nodes (44): AdapterResolver, _aware_utc(), DataGap, _load_gap(), _mark_unrecoverable(), missing_cadence_windows(), datetime, Protocol (+36 more)

### Community 19 - "signal_regime.py"
Cohesion: 0.09
Nodes (62): _alignment_query(), _alignment_strength_query(), _aware_utc(), _base_cte(), build_signal_regime_report(), _component_regime_query(), _decorate_component_rows(), _decorate_signal_rows() (+54 more)
...
Cohesion: 0.09
Nodes (39): AIProfile, build_ai_context(), build_ai_symbol_context(), build_operator_read(), compact_dict(), compact_value(), daily_data(), daily_history() (+31 more)
...
### Community 23 - "WalkForwardManifestOptions"
Cohesion: 0.13
Nodes (24): freeze_walk_forward_manifest(), _options_from_spec(), The caller-controlled configuration portion of the manifest spec. Deliberately…, Stage A (Freeze): create or idempotently reuse an immutable manifest. Freeze…, Fail closed on any invalid or out-of-contract manifest option. No CLI option…, _static_options_spec(), _valid_manifest_name(), validate_manifest_options() (+16 more)

### Community 24 - "number"
Cohesion: 0.15
Nodes (42): dailySeries(), dateTime(), executionClass(), externalClass(), externalMetricValue(), imbalanceCell(), loadSection(), nd() (+34 more)

### Community 25 - "test_market_data_integrity_collector.py"
Cohesion: 0.12
Nodes (20): BookStore, bybit_liquidated_position_side(), handle_bybit(), now_ms(), parse_sequence(), Any, Escalera completa por venue, para calcular slippage de cualquier tamanio.…, _FakeBybitSocket (+12 more)
...
Cohesion: 0.14
Nodes (42): _actionable_evaluated(), _aware_utc(), _build_execution_views(), _build_gross_views(), _canonical_json(), _classify_execution_generalization(), _classify_generalization(), _clock_fold_state() (+34 more)
...
Cohesion: 0.10
Nodes (50): lifespan(), get_settings(), apply_retention(), backfill(), cycle(), Pool, run(), acquire_service_lock() (+42 more)
...
Cohesion: 0.07
Nodes (25): CoinalyzeClient, CoinalyzeError, CoinalyzeRateBudget, PostgresSlidingWindowRateLimiter, Any, Pool, Protocol, RuntimeError (+17 more)

### Community 46 - "test_signal_walk_forward.py"
Cohesion: 0.14
Nodes (20): compute_folds(), _execution_measure(), _group_stats(), _next_minute_strictly_after(), _percentile(), Freeze expanding-discovery / contiguous-non-overlapping-test folds. Fold 1:…, _execution_row(), parametrize (+12 more)
...
Cohesion: 0.10
Nodes (16): _liquidation_history_observation(), Validate event-history observation without inventing cadence from silence., CaptureConn, GapConn, LiquidationObservationConn, asyncio, test_combined_orderbook_requires_two_venues(), test_futures_combined_materializers_require_two_venues() (+8 more)
...
Cohesion: 0.08
Nodes (21): compute_session(), _coverage_complete(), _expected_session_samples(), latest_closed_session_date(), date, datetime, Mide distribuciones usando exclusivamente buckets historicos ya cerrados., refresh_baselines() (+13 more)
...
Cohesion: 0.18
Nodes (10): mark_feed_connected(), Mark a market feed healthy without resetting an existing healthy period., Any, asyncio, parametrize, RecordingConnection, test_mark_feed_connected_preserves_an_existing_healthy_since(), test_shard_without_symbols_cannot_publish_feed_health() (+2 more)
...
### Community 71 - "hypothesis_evidence"
Cohesion: 0.09
...
Cohesion: 0.25
Nodes (31): date, session_bounds(), _connect(), _daily_snapshot(), _drop(), _dsn(), _no_swing(), _observation() (+23 more)

### Community 74 - "test_signal_attribution_postgres.py"
Cohesion: 0.35
...
Cohesion: 0.05
Nodes (76): compute_and_store_all(), compute_regime(), compute_snapshot(), insert_snapshot(), _liquidation_history_observed(), normalized_cvd_imbalance(), optional_finite(), datetime (+68 more)
...
### Community 81 - "test_signal_backtest_postgres.py"
Cohesion: 0.38
...
### Community 90 - "test_pr23_temporal_integrity.py"
Cohesion: 0.27
Nodes (11): valid_trade(), asyncio, MonkeyPatch, test_combined_book_materializer_bounds_latest_venues_by_db_clock(), test_future_binance_book_is_dropped_and_requests_resync(), test_future_bybit_book_is_dropped_and_requests_resync(), test_future_trade_is_rejected_at_reception_time(), test_macro_daily_query_excludes_sessions_after_cutoff() (+3 more)
...
### Community 94 - "test_p2_baselines.py"
Cohesion: 0.11
...
### Community 99 - "attribute_signals.py"
Cohesion: 0.33
...
### Community 104 - "zone_character_read"
Cohesion: 0.16
...
### Community 110 - "backtest_signals.py"
Cohesion: 0.33
Nodes (10): _csv_rows(), _json_default(), main(), _parse_csv_tuple(), Any, Namespace, Path, _run() (+2 more)
...
### Community 116 - "signal_ledger.py"
Cohesion: 0.17
...
### Community 123 - "test_pr23_temporal_integrity_postgres.py"
Cohesion: 0.41
...
Cohesion: 0.14
Nodes (14): Fold states, Folds, Gross views, Integrity counters, Integrity counters, Knowledge-time rules, Labels, Manifest hash and idempotency (+6 more)
...
### Community 132 - "test_pr24_daily_historical_integrity.py"
Cohesion: 0.13
Nodes (14): CaptureConnection, ObservationCapture, PoolContext, Any, asyncio, datetime, MonkeyPatch, test_ai_verdict_history_is_current_cohort_and_immutable_targets() (+6 more)
...
### Community 136 - "assigned_symbols"
Cohesion: 0.62
...
### Community 146 - "Execution-adjusted OOS"
Cohesion: 0.50
...
### Community 149 - "Two sampling views"
Cohesion: 0.67
...
Cohesion: 0.40
Nodes (3): _DailyReplayConnection, Replay cutoff must constrain each percentile population and the selected rows., test_daily_replay_applies_as_of_to_history_and_selected_rows()
...
Cohesion: 0.11
Nodes (37): CadenceCoverage, Coverage proof for one exact cadence identity and half-open window., _coverage_heartbeat_detail(), finite(), ingest_cycle(), ingest_metrics_cycle(), ingest_ohlcv_cycle(), persist_liquidation_history_observations() (+29 more)

### Community 166 - "Sampling"
Cohesion: 0.67
...
### Community 206 - "Two stages"
Cohesion: 0.67
Nodes (3): Stage A: Freeze, Stage B: Evaluate, Two stages

### Community 210 - "test_data_gaps_postgres.py"
Cohesion: 0.32
Nodes (19): _cadence_gap(), _chart_rows(), _connect(), _ExactAdapter, _mask_chart(), asyncio, datetime, MonkeyPatch (+11 more)

### Community 211 - "test_p0_regresion_auditoria.py"
Cohesion: 0.13
...
### Community 218 - "test_metrics_endpoint.py"
Cohesion: 0.11
...
### Community 219 - "test_signal_replay_postgres.py"
Cohesion: 0.47
...
### Community 220 - "classify_absorption"
Cohesion: 0.20
...
### Community 224 - "BucketStore"
Cohesion: 0.15
Nodes (8): Bucket, BucketStore, RtBucket, asyncio, test_ack_does_not_drop_bucket_changed_during_flush(), test_bucketstore_caps_realtime_buckets_during_database_outage(), test_valid_trade_rejects_bad_values(), test_whale_trade_threshold_is_asset_specific()

### Community 225 - "GapRequirement"
Cohesion: 0.50
...
## Knowledge Gaps
- **541 isolated node(s):** `Condition`, `LANG`, `LC_ALL`, `DEBIAN_FRONTEND`, `PGPASSWORD` (+536 more)
...
- **Why does `_Connection` connect `_Connection` to `test_ingest.py`, `api.py`, `signal_backtest.py`, `calibrate_signals.py`, `signal_replay.py`, `Settings`, `test_pr22_cvd_semantics_postgres.py`, `ServiceOwnershipLost`, `scalp_collector.py`, `signal_execution.py`, `data_gaps.py`, `signal_regime.py`, `ai_context.py`, `WalkForwardManifestOptions`, `ValueError`, `ServiceOwnership`, `profile_read`, `ingest.py`, `external_macro.py`, `CoinalyzeClient`, `test_partitioning_postgres.py`, `test_pr21_point_in_time.py`, `test_pr20_semantics.py`, `signal_outcomes.py`, `test_market_feed_health.py`, `data_confidence_row`, `signal_attribution.py`, `test_pr24_daily_historical_integrity_postgres.py`, `test_signal_attribution_postgres.py`, `test_pr22_cvd_semantics.py`, `test_pr21_point_in_time_postgres.py`, `test_signal_backtest_postgres.py`, `test_data_gaps_postgres.py`, `TradeStore`, `test_partition_compatibility_bridge.py`, `test_signal_ledger_postgres.py`, `divergence_scan`, `test_signal_replay_postgres.py`, `conn`, `GapRequirement`, `_PoolContext`, `signal_ledger.py`, `scalp_logic.py`, `test_pr23_temporal_integrity_postgres.py`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `compute_scalp_summary()` connect `compute_scalp_summary` to `api.py`, `test_v150_criticos_y_oi.py`, `basis_quality`, `signal_replay.py`, `test_v150_ejecucion.py`, `scalp_collector.py`, `test_p0_regresion_auditoria.py`, `ai_context.py`, `scalp_logic.py`, `test_signal_replay_postgres.py`, `classify_absorption`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Settings` connect `Settings` to `ServiceOwnership`, `test_ingest.py`, `_DailyReplayConnection`, `ingest.py`, `external_macro.py`, `ServiceOwnershipLost`, `asyncio`, `test_daily_semantics.py`, `CoinalyzeClient`, `_Connection`, `test_data_gaps_postgres.py`, `divergence_scan`, `ValueError`?**
...
- **Are the 78 inferred relationships involving `ValueError` (e.g. with `normalize_profile()` and `.acquire()`) actually correct?**
  _`ValueError` has 78 INFERRED edges - model-reasoned connections that need verification._
